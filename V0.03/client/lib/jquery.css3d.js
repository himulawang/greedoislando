...
$.extend({
    css3d : function(el){
        ...
        el.startFrame = function(){
            ...
            this._setFirstFrame();
            var _this = this;
            setTimeout(function(){_this.loopFrame();},50);
            return this;
        }
        ...
        el._setFirstFrame = function(){
            var f = this.css3.firstFrame;
            if(f) this.css("-webkit-transition","").css(f);
            return this;
        }
        el._setLastFrame = function(){
            var f = this.css3.lastFrame;
            if(f) this.css("-webkit-transition","").css(f);
            return this;
        }
